...
export function MiniPlayer() {
  ...
  useEffect(() => {
    ...
    fill.value = stepping
      ? withTiming(progress, { duration: 1000, easing: Easing.linear })
      : progress;
...
const s = StyleSheet.create({
  ...
  title: { fontFamily: Font.bold, fontSize: 13.5, color: Palette.text },
  artist: { fontFamily: Font.regular, fontSize: 11.5, color: 'rgba(255,255,255,0.65)', marginTop: 1 },
